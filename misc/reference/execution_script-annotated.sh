...
## TODO re-order functions below using Robert's workflow file as reference
...
## TODO check to see if this warning occurs
...
## TODO Keep in mind possible HDF/inunmap error for some particular HUCs
...
## TODO ensure use of Python2 version of this grass script
## TODO include conda environment switch function here
## TODO find Robert's version of this script in Robert's Stampede2 WORK directory
##  ref: email with Robert
...
## TODO non-standard: find version in Robert's WORK
## TODO consider excluding and using existing _path.tif results in UT Box
# python $HomeDir/Tools/GeoNet_Batch/pygeonet_shapefile2binaryraster_pathburn.py $ScratchDir $projectName $DEM_name

## TODO Modify Python file itself to set split_distance=1000
